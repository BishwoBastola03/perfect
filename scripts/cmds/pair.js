...
const { loadImage, createCanvas } = require("canvas");
 ...
 return api.sendMessage({ body: `Congratulations, ${name1}! It appears that the celestial bodies have conspired to unite you with ${name2}. Your cosmic bond is nothing short of extraordinary, with an astonishing compatibility rating of ${tile}%! 🌟✨🔮`,
 mentions: [{
 tag: `${name2}`,
 id: id2
